...
export function ErrorBanner({ title, description, actionLabel = "Retry", onRetry }: ErrorBannerProps) {
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-l-4 border-red-200 border-l-red-400 bg-red-100/80 p-4 text-red-950 dark:border-red-300/40 dark:border-l-red-400 dark:bg-red-950/55 dark:text-red-50 sm:flex-row sm:items-center sm:justify-between">
